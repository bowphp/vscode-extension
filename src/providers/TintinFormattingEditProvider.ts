...
export class TintinFormattingEditProvider implements vscode.DocumentFormattingEditProvider, vscode.DocumentRangeFormattingEditProvider
{
  formatterOptions: ITintinFormatterOptions;
  ...
  private provideFormattingEdits(
    ...
    // format as blade
    let formatter = new TintinFormatter(this.formatterOptions);
